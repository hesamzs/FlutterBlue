...
class writeData extends StatefulWidget {
  ...
  writeData({required Key key, required this.callback}) : super(key: key);
...
void writeOnDevice(targetDevice) async {
    ...
    for (BluetoothCharacteristic characteristic in service.characteristics) {
      if (characteristic.properties.notify) {
        ...
        if (characteristic.properties.write == true) {
          await characteristic.write([0xFA, 0xFA, 0xFA, 0xFA, 0xFA]); // Hex Code
        }
      }
    }
  }
